...
public class ModuleData extends RPCStruct {
	...
	public static final String KEY_AUDIO_DATA		= "audioControlData";
	...
	private AudioControlData getAudioData(){
		 Object obj = store.get(KEY_AUDIO_DATA);
		if (obj instanceof ClimateControlData) {
			return (AudioControlData)obj;
		}else if(obj instanceof Hashtable){
			return new AudioControlData((Hashtable<String,Object>)obj);
		}
		return null;
	...
	public void setControlData(ControlData data){
		...
		switch(type){
			...
			case CLIMATE:
				...
				break;
			case AUDIO:
				addToStore(KEY_AUDIO_DATA, data);
			//Anymore cases can be added here as we add more types
			default:
				return;
		}
